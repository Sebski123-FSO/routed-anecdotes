...
Anecdote.propTypes = { anecdote: PropTypes.object.isRequired };
...
const About = () => (
  <div>
    ...
    <em>
      ...
      to reveal a truth more general than the brief tale itself, such as to
      ...
      the concrete details of a short narrative. An anecdote is &rdquo;a
      story with a point.&rdquo;
    </em>
